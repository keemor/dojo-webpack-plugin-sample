                ...
                if (this.get("content") == "") {
                    ...
                    if (title == "Calendar") {
                        ...
                        require([
                            ...
                            c
                                .addPlot("default", { type: "StackedAreas", tension: 3 })
                        ...
                        // require(["dijit/Editor", "dijit/TitlePane"], lang.hitch(this, function(editor) {
                        //     dconst.empty(this.domNode);
                        //     new editor({
                        //         plugins: ["bold", "italic", "|", "cut", "copy", "paste", "|", "insertUnorderedList"]
                        //     }).placeAt(this.domNode);
                        ...
                        // console.info(1);
                        require(["dijit/TitlePane"], lang.hitch(this, function(titlePane) {
                            console.info(2);
                            this.set("content", new titlePane({ title: "Test" }));
